...
ITEM_PIPELINES = {
    # 'TweetScraper.pipelines.SaveToSingleFilePipeline': 100,
    # 'TweetScraper.pipelines.SaveToFilePipeline': 200,
    'TweetScraper.pipelines.SaveToMongoPipeline': 300,  # replace `SaveToFilePipeline` with this to use MongoDB
}
...
MONGODB_UPDATE = False  # update existing itens
